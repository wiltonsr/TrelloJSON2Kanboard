...
return array(
    ...
    'New Import Trello Project (JSON File)' => 'Nova importação de Projeto Trello (Arquivo JSON)',
    'Trello JSON File' => 'Arquivo JSON do Trello',
    'Maximum size: ' => 'Tamanho máximo: ',
    'Public project' => 'Projeto público',
    ...
    'Internet connection not detected. Attachments will not be downloaded automatically' => 'Conexão com a Internet não detectada. Anexos não serão baixados automaticamente',
    'Internet connection detected. Attachments will be downloaded automatically' => 'Conexão com a Internet detectada. Os anexos serão baixados automaticamente',
